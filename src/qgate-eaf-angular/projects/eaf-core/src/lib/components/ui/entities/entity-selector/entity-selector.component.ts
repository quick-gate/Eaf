import { Component, OnInit, Input, Output, EventEmitter, ViewChild,
  ViewContainerRef, ComponentRef, ComponentFactoryResolver, Inject } from '@angular/core';
...
export class EntitySelectorComponent implements OnInit {
  ...
  @ViewChild('entityContainer', { read: ViewContainerRef, static: false }) entityContainer: ViewContainerRef;
